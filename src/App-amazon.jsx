...
/* =========================================================================
   ...
   Reviews-only environment with Helpful, Report, and Read more interactions.
   ========================================================================= */
...
if (typeof document !== "undefined") {
  ...
  document.body.classList.toggle("amz-mode", MODE === "amz" || APP === "amz");
}
                        ...
                        <FBFeed
                          ...
                          onSubmit={async () => {
                            ...
                            if (!ok) {
                              ...
                              // No toast here either — see App-facebook.jsx's
                              // identical branch for why (the overlay already
